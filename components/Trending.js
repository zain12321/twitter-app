...
const Trending = () => {
    return (
     ...
     gap-2 rounded-full py-2 px-4 text-white items-center text-[20px] sticky top-1 z-10'>
                <FiSearch />
                <input className='bg-transparent w-[100%] outline-none' type="text" placeholder='Search Twitter' />
            </div>


            <div className='bg-[#16181C] sticky top-14 rounded-[20px] text-white mt-4 px-4 py-4'>
